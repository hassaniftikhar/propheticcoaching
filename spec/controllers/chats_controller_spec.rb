...
describe ChatsController do
  ...
  #      post :create, {:chat => { "new" => "invalid value" }}, valid_session
  #      assigns(:chat).should be_a_new(Chat)
  #    end
  #
  ...
  #      Chat.any_instance.should_receive(:update).with({ "new" => "MyString" })
  #      put :update, {:id => chat.to_param, :chat => { "new" => "MyString" }}, valid_session
  #    end
  #
  #    it "assigns the requested chat as @chat" do
  #      chat = Chat.create! valid_attributes
  ...
  #      # Trigger the behavior that occurs when invalid params are submitted
  #      Chat.any_instance.stub(:save).and_return(false)
  #      put :update, {:id => chat.to_param, :chat => { "new" => "invalid value" }}, valid_session
  #      assigns(:chat).should eq(chat)
  #    end
  #
