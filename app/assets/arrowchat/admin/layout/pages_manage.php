...
?>
					...
					<div class="subExplain"><i>Notifications must first be installed correctly to function properly. Please visit arrowchat.com/support/ for documentation on installation.</i></div>
