					...
					<fieldset class="firstFieldset">
						...
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									Allows users to use the site notifications feature. This feature must first be installed correctly to function. Please visit arrowchat.com/support/ for documentation on installation.
								</p>
							</dd>
						</dl>
					<?php
								...
								<ul>
									<li>
										<label for="file_transfer_on">
											...
											Enable Users to Transfer Files
										</label>
									</li>
								</ul>
								<p class="explain">
					...
					?>
						<dl class="selectionBox">
							...
							<dd>
								...
								<p class="explain">
									If you would like your users to be able to connect to Facebook and chat with their Facebook friends enter your Facebook app ID here.  <a target="_blank" href="http://anonym.to/?http://www.arrowchat.com/documentation/?p=facebook-integration">Click here for instructions on how to get and setup your Facebook app</a>.  Leave this BLANK if you do not want to use Facebook integration.
								</p>
							</dd>
						</dl>
					<?php
								...
								<ul>
									<li>
										<label for="admin_chat_all">
											...
											ArrowChat Admins Can View All Online
										</label>
									</li>
								</ul>
								<p class="explain">
									Checking this will allow administrators to view all online users instead of just friends. You can set a user as an admin by clicking 'Manage Users'.
								</p>
							</dd>
						</dl>
						<dl class="selectionBox">
