    ...
    a.arrowchat = function () {
        ...
        function Sa(b) {
         if (a(b).attr("id"))
			...
			a(".ui-icon-arrow-l").css("background-position", "-144px -1px").css("background-color", "rgba(0,0,0,.4)");
            ...
            b && a.each(b, function (i, e) {
                if (i == "buddylist") {
                    ...
                    a.each(e, function (l, f) {
                        ...
                        c[f.s] += '<li data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-btn-up-c"><div class="ui-btn-inner ui-li"><div class="ui-btn-text" id="arrowchat_userlist_' + f.id + '"><a data-transition="slide" href="#page2" class="ui-link-inherit user-window">' + avatar + longname + '<div class="mobile_alert"' + alert_show + '>'+lang[115]+'</div></a></div><span class="ui-icon ui-icon-arrow-r ui-icon-shadow"></span></div></li>';
                        uc_status[f.id] = f.s;
                        uc_name[f.id] = f.n;
                        uc_avatar[f.id] = f.a;
                        uc_link[f.id] = f.l
						...
						if (no_error) {
							...
							a("#send_button_chatroom").click(function () {
								...
								if (msgcount > 4 && chatroom_admin != 1 && chatroom_mod != 1) {
									a("#chatroom-error-content").html(lang[51]);
									a.mobile.changePage( "#chatroom-error", { transition: "slidedown", changeHash: true });
								} else {
									i != "" && a.post(c_ac_path + "includes/json/send/send_message_chatroom.php", {
										userid: u_id,
										username: u_name,
										chatroomid: Ccr,
										message: i
							...
							o && a.each(o, function (i, e) {
								...
								if (i == "chat_users") {
									...
									a.each(e, function (l, f) {
										...
										a("#chatroom-users-list").append('<li data-theme="a" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-btn-up-a arrowchat_chatroom_admin_' + f.t + '"><div class="ui-btn-inner ui-li"><div class="ui-btn-text" id="arrowchat_chatroom_user_' + f.id + '"><a data-transition="slide" href="#" class="ui-link-inherit user-window">' + avatar + f.n + '</a></div><span class="ui-icon ui-icon-arrow-r ui-icon-shadow"></span></div></li>');
										if (f.t == 2) {
		...
		function setUserOptions(f, global_admin, global_mod) {
			a('#arrowchat_chatroom_user_' + f.id).click(function() {
				...
				if ((global_admin == 1 || global_mod == 1) && (f.t == 1)) {
					a("#user-options-content").append(mod_button + ban_button);
				}
				if (global_admin == 1 && f.t == 2) {
        ...
        function qa(b, c, d, e, l, f) {
			...
			if (a("#arrowchat_userlist_" + b).length > 0) {
                ...
                longname = c.length > 25 ? c.substr(0, 25) + "..." : c;
				if (c_disable_avatars != 1)
					avatar = '<div class="mobile_avatar"><img src="'+e+'" /></div>';
                a("#buddylist-container-available").append('<li data-theme="c" class="ui-btn ui-btn-icon-right ui-li-has-arrow ui-li ui-btn-up-c"><div class="ui-btn-inner ui-li"><div class="ui-btn-text" id="arrowchat_userlist_' + b + '"><a data-transition="slide" href="#page2" class="ui-link-inherit user-window">' + avatar + longname + '<div class="mobile_alert">'+lang[115]+'</div></a></div><span class="ui-icon ui-icon-arrow-r ui-icon-shadow"></span></div></li>');
				if (j != b) {
					a("#arrowchat_userlist_" + b + " .mobile_alert").show();
					if (a.mobile.activePage.attr("id") != "page1"){a(".ui-icon-arrow-l").css("background-position", "-503px -1px").css("background-color", "#9b3c3c");}
				}
			}
