<?php 
	...
	*/
	...
	require_once dirname(dirname(dirname(__FILE__))).\"/includes/config.php\";";
		...
		if ($_SESSION['version'] == "vbulletin5")
			$include_data = "
	...
	*/
	function getFinalInstructions($version) 
	{
		switch($version)
		{
			...
			case "elgg":
				return "In Elgg, you can edit the header and footer files by going to the following folder: /views/default/page/elements/.  Then, edit the head.php and footer.php files.  You may also need to clear the Elgg cache by clicking 'Flush the caches' in the dashboard of the Elgg administrator panel.";
				break;
