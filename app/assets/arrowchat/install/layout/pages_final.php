		...
		<?php
			...
			{
		?>
				<div style="margin-top:10px;">We detected that you are using vBulletin so another step is required to get avatars working.  http://www.arrowchat.com/support/downloads/vb_avatars.zip, Download this file from ArrowChat and extract it to your vBulletin root folder.</div>
		<?php
			}
		?>
