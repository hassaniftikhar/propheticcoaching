<?php 
	...
	*/
	...
	function get_friend_list($userid, $time) 
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, arrowchat_status.session_time lastactivity, " . TABLE_PREFIX . "profile_portal." . DB_USERTABLE_AVATAR . " avatar, CONCAT(" . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . ",'-'," . TABLE_PREFIX . DB_USERTABLE . ".members_seo_name) link, arrowchat_status.is_admin, arrowchat_status.status 
			...
			LEFT JOIN " . TABLE_PREFIX . "profile_portal 
				ON " . TABLE_PREFIX . "profile_portal.pp_member_id = " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " 
	...
	function get_online_list($userid, $time) 
	{
		...
		$sql = ("
			...
			JOIN arrowchat_status 
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = arrowchat_status.userid 
			LEFT JOIN " . TABLE_PREFIX . "profile_portal
				ON " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " = " . TABLE_PREFIX . "profile_portal.pp_member_id 
	...
	function get_link($link, $user_id) 
	{
		...
		return $base_url . '../index.php?/user/' . $link;
	}
	...
	function get_avatar($image, $user_id) 
	{
		...
		{
			return $base_url . '../public/style_images/master/profile/default_thumb.png';
		}
	}
